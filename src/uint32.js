...
(function(exporter) {
  ...
  /**
     ...
     *  @return highByte concat secondHighByte concat thirdHighByte concat lowByte
     */
  ...
  /**
     ...
     *  @return {Number} the 0-255 byte according byteNo
     */
  ...
  /**
     ...
     *  @param {Number} uint32value the source to be extracted
     *  @return {Array} the array [highByte, 2ndHighByte, 3rdHighByte, lowByte]
     */
  ...
  /**
     ...
     *  @return {Number} the uint32 value of the shifted word
     */
  ...
  /**
     ...
     *  @return the sum of the given values modulus 2^32
     */
